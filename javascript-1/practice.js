...
let total = myNumbers.reduce((acc, curValue) => acc + curValue)
...
let enemies = people.filter(person => person.friend !== true);
...
let totallyAwesome = people.reduce((acc, currentVal) => acc + currentVal.awesomeLevel, 0);
